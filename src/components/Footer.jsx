    ...
    <footer className="bg-gray-900 text-gray-200 py-10">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm">
            Welcome to [App Name], where talented contestants showcase their
            skills and compete for exciting cash prizes. Join our community to
            vote, participate, and support your favorite contestants.
          </p>
        </div>
