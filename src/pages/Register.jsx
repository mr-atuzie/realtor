  ...
  return (
    <div className=" w-full text-lg font-medium flex justify-center items-center h-screen">
      <form className=" w-[90%] lg:w-[38%] ">
        ...
        <button
          className=" w-full text-center py-2 my-7 bg-white border text-black rounded-full"
          type="submit"
        >
          <FcGoogle />
          Sign up with Google
        ...
        <button
          className=" w-full text-center py-2 my-2 bg-white border text-black  rounded-full"
          type="submit"
        >
          <FaFacebook />
